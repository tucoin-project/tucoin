...
uint256 hashGenesisBlock("0x0ebf0b3c1240d6d5f8433015c64ab20c546e6037d0e05437ab6d614f7034df51");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 100); // TUcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 10 * 30; // TUcoin: 5 minutes
static const int64 nTargetSpacing = 1 * 30; // TUcoin: 30 seconds
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0ebf0b3c1240d6d5f8433015c64ab20c546e6037d0e05437ab6d614f7034df51");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1511162691;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1251173;
        ...
        assert(block.hashMerkleRoot == uint256("0xdc51eaf455a371711920735f85e06aa497949eb833819544357a00372ebcee70"));
